var dueloApp = angular.module('dueloApp', ['ui.router']);

dueloApp.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
        ...
        .state('iniciarDuelo', {
            url: '/iniciar',
            templateUrl: 'Iniciar-duelo.html',
            controller: function($scope, $http) {
            	...
            	$scope.actualizarLista = function() {
                    posiciones.findAll(function(data) { 
